...
(0, _jquery2.default)('.js-back').each(function (i, el) {
  (0, _jquery2.default)(el).on('click', function () {
    setTimeout(function () {
      (0, _jquery2.default)('.modal[data-type="info"]').find('.modal__content').html('');
      (0, _jquery2.default)(el).closest('.modal').hide();
      (0, _jquery2.default)('.modal[data-type="verify"]').show();
    }, 100);
  });
});
(0, _jquery2.default)('input').each(function (i, el) {
  (0, _jquery2.default)(el).keyup(function (e) {
    if (e.which == 69) {
      (0, _jquery2.default)(el).val('');
    }
    if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
      return false;
    }
    if ((0, _jquery2.default)(el).val() > 1) {
      (0, _jquery2.default)(el).val((0, _jquery2.default)(el).val().slice(0, 1));
    }
    if (e.which != 8) {
      if ((0, _jquery2.default)('input')[i + 1] != undefined) {
        (0, _jquery2.default)('input')[i + 1].focus();
      } else {
        (0, _jquery2.default)('input')[i].blur();
      }
    } else {
      if ((0, _jquery2.default)('input')[i - 1] != undefined) {
        (0, _jquery2.default)('input')[i - 1].focus();
...
(0, _jquery2.default)('.js-submit').on('click', function (e) {
  e.preventDefault();
  var identificator = (0, _jquery2.default)('form').serializeArray().map(function (el, i) {
    return el.value;
  });
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === 4) {
      if (xhr.status === 200) {
        ...
        (0, _jquery2.default)('.modal[data-type="verify"]').hide();
        (0, _jquery2.default)('.modal[data-type="error"]').show();
      }
    }
  };
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(94), __webpack_require__(93)(module)))
